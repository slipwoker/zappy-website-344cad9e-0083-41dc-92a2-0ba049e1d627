document.addEventListener('DOMContentLoaded', function() {
  ...
  style.textContent = `
    .fade-in.visible, [data-animate="fade-in"].visible {
      opacity: 1 !important;
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "דניאל רוליה משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var response = await fetch(apiBase + '/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '344cad9e-0083-41dc-92a2-0ba049e1d627',
                    name: data.name || '',
                    email: data.email || '',
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '344cad9e-0083-41dc-92a2-0ba049e1d627';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '344cad9e-0083-41dc-92a2-0ba049e1d627';
